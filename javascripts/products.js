		...
		var btnToys = document.getElementById("btnOnesies");
		var divOnesies = document.getElementById("btnOnesies");
		...
		btnDiaperBags.addEventListener("click", function(){
			...
			for(i = 0; i < len; i++){
				...
				var img = document.createElement("img");
					img.setAttribute("src", "images/" + products.diaperbags[i].id + ".jpeg");	
					div.appendChild(img);
        ...
        btnToys.addEventListener("click", function(){
			...
			for(i = 0; i < len; i++){
				...
				var img = document.createElement("img");
					img.setAttribute("src", "images/" + products.toys[i].id + ".jpeg");	
					div.appendChild(img);
        ...
        btnOnesies.addEventListener("click", function(){
			...
			for(i = 0; i < len; i++){
				...
				var img = document.createElement("img");
					img.setAttribute("src", "images/" + products.onesies[i].id + ".jpeg");	
					div.appendChild(img);
        ...
        btnCostumes.addEventListener("click", function(){
			...
			for(i = 0; i < len; i++){
				...
				var img = document.createElement("img");
					img.setAttribute("src", "images/" + products.costumes[i].id + ".jpeg");	
					div.appendChild(img);
        ...
        btnMusic.addEventListener("click", function(){
			...
			for(i = 0; i < len; i++){
				...
				var img = document.createElement("img");
					img.setAttribute("src", "images/" + products.music[i].id + ".jpeg");	
					div.appendChild(img);
